...
/**
 * Archivo php donde nos permite generar QA automáticamente
 * Autor: Ruben -Grupo Imeda
 * Fecha: 15/12/2017
 */

class AsignacionQA_GENERAR {
...
//bucle foreach que comprueba que idioma esta seleccionado para cargar los strings
        ...
        <section>
            ...
            <div class="form2">
                <h4><?php echo $strings['Generación de QA automática']; ?></h4>
                <form action="../Controllers/AsignacionQA_Controller.php" method="post" onblur="generaQA(1)">
                    <select name="NombreTrabajo">
                        ...
                        while($row = $trabajos->fetch_array()){
                            ?>
                            <option value="<?php echo $row['NombreTrabajo']?>" ><?php echo $row['NombreTrabajo']?></option>
                        <?php }?>
                    </select>
                    <br>
                    <input type="number" class="form-control" maxlength="2" value="1" size="2" step="1.0" onblur="messagedel(this);comprobarVacio(this); comprobarTexto(this,2)" id="NumeroAsig1" name="NumeroAsig" tabindex="1" >

                    <div class="boton-grup">
                        <button name="action" value="GenerarQA" type="submit" class="boton-env">
