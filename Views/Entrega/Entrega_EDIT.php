            ...
            <div class="form">
                ...
                <form class="form-basic" enctype="multipart/form-data"  method="post" action="../Controllers/Entrega_Controller.php" onsubmit="return comprobarEntEDIT();">
                    <div class="form-group">
                        ...
                        <input readonly type="text" value="<?php echo $group['IdTrabajo']; ?>" class="form-control" maxlength="6" size="6" id="IdTrabajo" name="IdTrabajo"  tabindex="1">
                    ...
                    <div class="form-group">
                        ...
                        <input readonly type="text" value="<?php echo $group['Alias']; ?>" class="form-control" maxlength="60" size="60" id="Alias" name="Alias" tabindex="1"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo $group['Horas']; ?>" class="form-control" maxlength="2" size="100" id="Horas" name="Horas" tabindex="1"
