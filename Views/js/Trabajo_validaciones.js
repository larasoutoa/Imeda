...
/**
 * Funciones javascript para validar los campos de los formularios de las vistas de trabajo
 ...
 */
	...
	function comprobarTrabajoADD(){

        var id; //obtenemos input id del formulario
        var name; //obtenemos input name del formulario
        var fechini; //obtenemos input fecha inicio del formulario
        var fechfin; //obtenemos input fecha fin del formulario
        var porcent;  //obtenemos input porcent del formulario
	    ...
	    name = document.getElementById("nombretrabajo1");
	    fechini = document.getElementById("fechaini1");
	    fechfin = document.getElementById("fechafin1");
	    porcent = document.getElementById("porcentaje1");
	    toret =true;
        ...
        //comprobamos los inputs con sus respectivas funciones de comprobaciones
	    if(!(comprobarVacio(name) && comprobarstartEspacio(name) && comprobarTexto(name,60))){
	        toret = false;
	        
	    }

        //comprobamos los inputs con sus respectivas funciones de comprobaciones
	    if(!(comprobarVacio(fechini))){
	        toret = false;
	        
	    }

        //comprobamos los inputs con sus respectivas funciones de comprobaciones
	    if(!(comprobarVacio(fechfin))){
	        toret = false;
	        
	    }

        //comprobamos los inputs con sus respectivas funciones de comprobaciones
	    if(!(comprobarVacio(porcent) && comprobarstartEspacio(porcent) && comprobarTexto(porcent,2))){
	        toret = false;
	...
	function comprobarTrabajoSEARCH(){
        ...
        //comprobamos los inputs con sus respectivas funciones de comprobaciones
	    if(!(comprobarstartEspacio(porcent) && comprobarTexto(porcent,2))){
	        toret = false;
