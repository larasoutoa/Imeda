...
/**
 * Nos permite editar una evaluacion por parte del profesor
 * Autor: Ruben - Grupo Imeda
 * Fecha: 28/11/2017
 */

class EVALUACION_EVALUAR2 {
    ...
    function pinta($datos){
        ...
        $datos; //Variable que guarda las evaluaciones a modificar por el profesor
        $i; //Vraiable que se usa de indice
                ...
                <form action="../Controllers/Evaluacion_Controller.php" method="POST" >
                    <table class="showall-tab">
                        <tr>
                            ...
                            <th><?php echo $strings['Incorrecto Profesor']; ?></th>
                            <th><?php echo $strings['Texto Correcion Profesor']; ?></th>
                        ...
                        while ($row = $datos->fetch_array()){
                            ...
                            <tr>
                                    ...
                                    if($row['CorrectoP'] == 1){ echo 'checked';} ?> id=""></td>
                                    <td><input type="radio" value="0" name="correcion<?php echo $i ?>" <?php
                                    //Si el valor es 1 muestra el checkbox como checked
                                    if($row['CorrectoP'] == 0){ echo 'checked';} ?> id=""></td>
                                    <td><textarea cols="30" maxlength="300" rows="10" value="<?php echo $row['ComentIncorrectoP']; ?>" name="correcionTexto<?php echo $i ?>" id=""><?php echo $row['ComentIncorrectoP']; ?></textarea></td>                                    
