<?php
/**
 * Archivo php donde nos permite seleccionar la QA de la que queremos generar sus notas
 * Autor: Marcos -Grupo Imeda
 * Fecha: 19/12/2017
 **/

class NotasQAS_GENERAR {
...
//Comprueba que idioma está seleccionado y carga el strings correspondiente
        ...
        <section>
            ...
            <div class="form2">
                <h4>Generación de Notas de QAS</h4>
                <form action="../Controllers/NOTAS_Controller.php" method="post" onblur="">
                    ...
                    <div class="boton-grup">
                        <button name="action" value="QAS" type="submit" class="boton-env">
